...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ route('app.dashboard') }}" class="logo">
      ...
      <span class="logo-mini"><b>Sistema</b>Notas<b>Yavirac</b></a></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Sistema</b>Notas<b>Yavirac</b></a></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="{{ route('app.dashboard') }}"><i class="fa fa-tachometer"></i> <span>Tablero</span></a></li>
        <li class="treeview">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a href="#">SistemaNotasYavirac</a>.</strong> All rights reserved.
  </footer>
